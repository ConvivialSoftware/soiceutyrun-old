...
class FirebaseMessagingHandler {
  ...
  void showAlert(BuildContext context, dynamic payload) {
    GatepassController.showGatepassDialog(
        payload: payload, onRedirection: () {});
  }
  ...
  void _showItemDialog(GatePassPayload payload, BuildContext context) {
    ...
    showDialog<bool>(
      ...
      print('after Dialog Close : ' +
          FirebaseMessagingHandler.isInAppCallDialogOpen.toString());
      if (shouldNavigate == true) {}
    });
  }

  void _showDynamicWidgetDialog(
      DBNotificationPayload payload, BuildContext context) {
    ...
    showDialog<bool>(
      ...
      print('after Dialog Close : ' +
          FirebaseMessagingHandler.isDynamicDialogOpen.toString());
      if (shouldNavigate == true) {}
    });
  }
}
