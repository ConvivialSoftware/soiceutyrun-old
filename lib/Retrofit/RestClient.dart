...
abstract class RestClient {
  ...
  Future<DataResponse> editProfileInfo(
      ...
      @Field("ALTERNATE_CONTACT2") String altCon2,
  ...
  Future<StatusMsgResponse> addMember(
      ...
      @Field(GlobalVariables.HOBBIES) String hobbies,
      @Field(GlobalVariables.TYPE) String membershipType,
      @Field(GlobalVariables.NOTE) String additionalInfo,
  ...
  Future<StatusMsgResponse> addStaffMember(
      ...
      @Field(GlobalVariables.block) String block,
      @Field(GlobalVariables.flat) String flat,
      @Field(GlobalVariables.STAFF_NAME) String name,
      @Field(GlobalVariables.GENDER) String gender,
      @Field(GlobalVariables.DOB) String dob,
      @Field(GlobalVariables.Contact) String mobile,
      @Field(GlobalVariables.QUALIFICATION) String qualification,
      @Field(GlobalVariables.ADDRESS) String address,
      @Field(GlobalVariables.NOTES) String notes,
      @Field(GlobalVariables.USER_ID) String userId,
      @Field(GlobalVariables.ROLE) String role,
      @Field(GlobalVariables.PHOTO) String picture,
      @Field(GlobalVariables.IDENTITY_PROOF) String identityProof,
      @Field(GlobalVariables.VEHICLE_NO) String vehicleNo);
