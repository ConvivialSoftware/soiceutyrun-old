...
class MobileUserState extends BaseStatefulState<BaseMobileUser>
          ...
          return Builder(
            builder: (context) => Scaffold(
              appBar: AppBar(
                ...
                title: text(
                  AppLocalizations.of(context).translate('mobile_user')+'/'+AppLocalizations.of(context).translate('not_mobile_user'),
            ...
            child: Stack(
              children: <Widget>[
                GlobalFunctions.getAppHeaderWidgetWithoutAppIcon(
                    context, 150.0),
                value.isLoading? GlobalFunctions.loadingWidget(context):getMobileUserListDataLayout(value),
              ],
            ),
          ),
        ],
          ...
          Flexible(
            child: Stack(
              children: <Widget>[
                GlobalFunctions.getAppHeaderWidgetWithoutAppIcon(
                    context, 180.0),
                value.isLoading ? GlobalFunctions.loadingWidget(context): getUnMobileUserListDataLayout(value),
              ],
            ),
          ),
        ],
  ...
  getMobileUserListItemLayout(int position, UserManagementResponse value) {
    return Container(
      width: MediaQuery.of(context).size.width / 1.1,
      padding: EdgeInsets.fromLTRB(15, 15, 15, 0),
      margin: EdgeInsets.fromLTRB(0, 10, 0, 10),
