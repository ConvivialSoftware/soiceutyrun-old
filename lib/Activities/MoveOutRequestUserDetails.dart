...
class BaseMoveOutRequestUserDetails extends StatefulWidget {
  ...
  @override
  _BaseMoveOutRequestUserDetailsState createState() =>
      _BaseMoveOutRequestUserDetailsState();
}

class _BaseMoveOutRequestUserDetailsState
    extends AppStatefulState<BaseMoveOutRequestUserDetails> {
  ...
  void initState() {
    ...
    tenantDetailsList = List<Tenant>.from(
        widget.moveOutRequest.tenant_name!.map((i) => Tenant.fromJson(i)));
                        ...
                        Container(
                          child: text(
                              GlobalFunctions.convertDateFormat(
                                  widget.moveOutRequest.AGREEMENT_TO!,
                                  "dd-MM-yyyy"),
                    ...
                    Row(
                      ...
                      children: [
                        InkWell(
                          onTap: () {
                            if (widget.moveOutRequest.AGREEMENT!.isNotEmpty) {
                              downloadAttachment(
                                  widget.moveOutRequest.AGREEMENT);
                            } else {
                        ...
                        InkWell(
                          onTap: () {
                            if (widget
                                .moveOutRequest.TENANT_CONSENT!.isNotEmpty) {
                              downloadAttachment(
                                  widget.moveOutRequest.TENANT_CONSENT);
                            } else {
                              GlobalFunctions.showToast(
                                  AppLocalizations.of(context)
                                      .translate('document_not_available'));
                    ...
                    Row(
                      ...
                      children: [
                        InkWell(
                          onTap: () {
                            if (widget
                                .moveOutRequest.OWNER_CONSENT!.isNotEmpty) {
                              downloadAttachment(
                                  widget.moveOutRequest.OWNER_CONSENT);
                            } else {
                              GlobalFunctions.showToast(
                                  AppLocalizations.of(context)
                                      .translate('document_not_available'));
                        ...
                        InkWell(
                          onTap: () {
                            if (widget.moveOutRequest.AUTH_FORM!.isNotEmpty) {
                              downloadAttachment(
                                  widget.moveOutRequest.AUTH_FORM);
                            } else {
                              GlobalFunctions.showToast(
                                  AppLocalizations.of(context)
                                      .translate('document_not_available'));
      ...
      child: Align(
        ...
        child: Container(
          margin: EdgeInsets.fromLTRB(
              0, 0, 0, 0), //margin: EdgeInsets.fromLTRB(20, 20, 20, 0),
          child: Card(
            shape: (RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(10.0))),
            elevation: 2.0,
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Container(
                          ...
                          child:
                              tenantDetailsList[position].PROFILE_PHOTO!.isEmpty
                                  ? AppAssetsImage(
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            child: text(
              AppLocalizations.of(context).translate('sure_move_out'),
  ...
  Future<void> moveOutMember() async {
    ...
    Provider.of<UserManagementResponse>(context, listen: false)
        .tenantMoveOut(widget.moveOutRequest.ID!, _reasonController.text,
