...
class ViewPollGraphState extends State<BaseViewPollGraph> {
  ...
  void initState() {
    ...
    for(int j=0;j<_optionList.length;j++){
      ...
      _totalParticipate += int.parse(_optionList[j].VOTES);
    }
  }
                ...
                SingleChildScrollView(
                  child: Container(
                    margin: EdgeInsets.fromLTRB(
                        10, MediaQuery.of(context).size.height / 5, 10, 0),
                    child: Column(
                      children: <Widget>[
                        Container(
    ...
    return Container(
      ...
      child: Row(
        children: [
          Container(
            child: Text(
              (position+1).toString()+')   '+_optionList[position].ANS+' - ',style: TextStyle(
          ...
          Container(
            ...
            child: Text(
             _optionList[position].VOTES+ ' Votes',style: TextStyle(
                color: GlobalVariables.black,fontSize: 16,fontWeight: FontWeight.normal
            ),),
          )
        ],
